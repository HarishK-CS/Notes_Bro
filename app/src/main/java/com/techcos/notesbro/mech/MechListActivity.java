...
public class MechListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        syllabus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                StorageReference dateRef = sr.child("MECH Syllabus" + ".pdf");
                dateRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    @Override
                    public void onSuccess(Uri uri) {
                        downloadManager = (DownloadManager) getSystemService(Context.DOWNLOAD_SERVICE);
                        DownloadManager.Request request = new DownloadManager.Request(uri);
                        request.setTitle("MECH Syllabus");
    ...
    BroadcastReceiver onDownloadComplete = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (reference == id) {
                Toast.makeText(MechListActivity.this, "Download Completed", Toast.LENGTH_SHORT).show();
            }
        }
    };
